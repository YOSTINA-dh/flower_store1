...
![Logo](https://i.ibb.co/whqM6mh/logo1.png)
...
I choose Balsamiq for the planning of the desktop and mobile version of FlowerStore e-commerce. 
...
14. Now you can commit all the changes and push to GitHub;
    ...
    `$ heroku git:remote -a flowerstore`
...
12. To connect Jdango to s3 add the below settings in settings.py which will tell it which bucket it should be communicating with;
        ...
        if 'USE_AWS' in os.environ:
            AWS_STORAGE_BUCKET_NAME = 'flowerstore-ms4'
...
1. Log in to GitHub and locate the GitHub Repository. flowerstore repository can be found [here](https://github.com/YOSTINA-dh/flower_store)
...
- Products Images were taken from ***Interflora***.
- Homepage Images were taken from ***lindt***.
- StackOverflow 
